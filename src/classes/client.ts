...
import * as dokdo from "../../dokdo/index.js";
...
export class ExtendedClient extends Client {
    ...
    super({
      ...
      sweepers: {
        users: {
          ...
          interval: parseInt(process.env.SWEEPER_INTERVAL as string),
        },
        guildMembers: {
  ...
  commands: Collection<string, AbstractCommand> = new Collection();
