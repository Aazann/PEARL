...
export default class StatsCommand extends AbstractCommand {
  ...
  async execute(client: ExtendedClient, ctx: Context) {
    ...
    const cpu = `${cpuUsage.toFixed(2)} %vCPU`;
